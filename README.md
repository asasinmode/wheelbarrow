...
_This is the 1.20.6 branch of the repository and it contains code for the 1.20.6 and 1.20.5 Minecraft versions. Code for the newest Minecraft version can be found on the main branch._
