...
_This is the main branch of the repository and it contains code for newest Minecraft version 1.20.5. Code for other Minecraft versions can be found on their respective branches._
